...
class Latte extends StatefulWidget {
  Coffee product;
  CoffeeShop store;
  Latte({super.key, required this.product, required this.store});
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        "The creamy milk and the rich espresso create a perfect harmony of flavors. Whether you prefer it hot or cold, with or without foam, a latte is always a delicious treat.",
