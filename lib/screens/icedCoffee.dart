...
class IcedCoffee extends StatefulWidget {
  Coffee product;
  CoffeeShop store;
  IcedCoffee({super.key, required this.product, required this.store});

  @override
  State<IcedCoffee> createState() => _IcedCoffeeState();
}
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        "Whether you like it black, sweetened, or with cream, iced coffee is a delicious and energizing drink that you can enjoy anytime",
