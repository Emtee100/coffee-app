...
class FlatWhite extends StatefulWidget {
  Coffee product;
  CoffeeShop store;
  FlatWhite({super.key, required this.product, required this.store});

  @override
  State<FlatWhite> createState() => _FlatWhiteState();
}

class _FlatWhiteState extends State<FlatWhite> {
    List drinkSize = [
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        "Flat White is made with espresso and steamed milk, creating a smooth and creamy texture. Flat white is perfect for coffee lovers who enjoy a strong flavor without too much foam or sweetness.",
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                Text("$noOfCoffee", style: GoogleFonts.mulish(
                                      color: Colors.white,
                                      fontSize: 17
                                    ),),
                                //SizedBox(width: 10,),
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                //mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text("Add to bag",style: GoogleFonts.mulish(
                                          fontWeight: FontWeight.w600,
                                          fontSize: 14
                                        ), ),
                                  const SizedBox(width: 15,),
                                  Text("\$ ${(widget.product.price * noOfCoffee).toStringAsFixed(2)}", style: GoogleFonts.mulish(
                                          fontWeight: FontWeight.w600,
                                          fontSize: 14
                                        ),)
                                ],
